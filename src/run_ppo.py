...
if __name__=='__main__':
    ...
    parser.add_argument('--seed', type=int, default=42, help="he random seed for data shuffling and value head initialization.")
    ...
    parser.add_argument('--temperature', type=float, default=0.2, help="The temperature value to control diversity during generation.")
    ...
    parser.add_argument('--num_outer_epochs', type=int, default=1, help="The number of epochs. (Outer training loop)")
    parser.add_argument('--num_inner_epochs', type=int, default=3, help="`The number of epochs. (Inner PPO loop)")
    ...
    parser.add_argument('--max_kl_div', type=float, default=10.0, help="The maximum KL divergence value for clamping.")
    parser.add_argument('--gae_lambda', type=float, default=0.9, help="The delta value for GAE computation to control the extent of applying TDL and MCE.")
