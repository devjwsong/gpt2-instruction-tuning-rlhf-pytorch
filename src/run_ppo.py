...
if __name__=='__main__':
    ...
    parser.add_argument('--max_reward', type=float, default=5.0, help="The maximum reward value. The reward range is set to [-max, max].")
    ...
    parser.add_argument('--num_inner_epochs', type=int, default=3, help="The number of epochs. (Innter PPO loop)'")
    ...
    parser.add_argument('--gae_lambda', type=float, default=0.9, help="The delta value for GAE computation.")
